...
export const mockReview = {
  ...
  status: 'Local Guide',
  rating: 5,
  content: '"The Cacio e Pepe was life-changing. We sat in a corner booth and could actually hear each other speak. The AI recommendation was spot on about the quiet vibe!"',
  images: [
...
export const nlpKeywords = ['Portion size: Generous', 'Authentic flavors', 'Date night spot', 'Cacio e Pepe', 'Table spacing: Wide'];
