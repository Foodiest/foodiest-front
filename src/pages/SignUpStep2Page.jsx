  ...
  return (
    <div className="bg-background text-on-background font-body-md min-h-screen pb-32">
      ...
      <header className="bg-white fixed top-0 w-full z-50 border-b border-slate-100 shadow-sm flex items-center justify-between px-6 py-4">
        <Link
          to="/"
          className="text-primary font-[Epilogue] text-lg font-bold tracking-tight"
        >
          Foodiest
        </Link>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-medium transition-all active:scale-95 ${
                      active
                        ...
                        : "border-outline-variant hover:border-primary text-on-surface bg-white"
                    }`}
                  >
                    <span
              ...
              {dietary.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`font-semibold text-sm whitespace-nowrap ${active ? "text-on-primary-container" : ""}`}
                    >
                      {item.label}
                    </span>
                  </button>
            ...
            <div className="flex gap-3 overflow-x-auto pb-2">
              {allergies.map((item) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`material-symbols-outlined text-sm ${active ? "text-primary" : "text-on-surface-variant"}`}
                    >
                      nutrition
                    </span>
