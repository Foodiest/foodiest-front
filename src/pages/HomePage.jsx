...
const vibes = ['Quiet', 'Lively', 'Romantic', 'Business'];
const tastes = ['Spicy', 'Sweet', 'Savory', 'Umami'];
const dietary = ['Nut-free', 'Gluten-free', 'Vegan'];
        ...
        <div className="relative z-10 w-full max-w-4xl px-6 text-center">
          ...
          <div className="bg-white p-2 rounded-xl shadow-xl flex flex-col md:flex-row gap-2">
            <div className="flex-1 flex items-center px-4 border-r border-slate-100">
              ...
              <input className="w-full border-none focus:ring-0 text-base py-3 outline-none" placeholder="Cuisine, restaurant, or keyword..." type="text" />
            </div>
            <div className="flex-1 flex items-center px-4 md:border-r border-slate-100">
              ...
              <input className="w-full border-none focus:ring-0 text-base py-3 outline-none" placeholder="Location..." type="text" />
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {tastes.map(t => (
                  <button
                    key={t}
                    onClick={() => toggle(selectedTastes, setSelectedTastes, t)}
                    className={`px-4 py-2 rounded-full text-sm font-medium transition-colors border ${
        ...
        <div className="lg:col-span-8">
          <div className="flex justify-between items-end mb-6">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">Based on your recent preference for "Quiet Italian"</p>
            </div>
          </div>
